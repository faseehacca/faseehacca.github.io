...
<div style="background: #1a1a1f; border-radius: 20px; padding: 1.8rem 2rem; max-width: 520px; margin: 0 auto;">
  <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.3rem;">
    <span style="font-size: 15px; font-weight: 500; color: #a0a0b0;">ACCA Journey</span>
    <span style="font-size: 13px; font-weight: 600; color: #a0a0b0; background: #2a2a35; padding: 4px 10px; border-radius: 999px;">7 of 17 exams</span>
  </div>
  ...
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 6px; margin-bottom: 1.4rem;">
    ...
    <div>
      <div style="background: #2a2a35; border-radius: 999px; height: 14px;"></div>
    </div>
  </div>
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 6px;">
    ...
    <div style="text-align: center;">
      <div style="font-size: 13px; font-weight: 500; color: #a0a0b0;">Skills</div>
      <div style="font-size: 11px; color: #606070; margin-top: 2px;">🔄 In Progress</div>
    </div>
    <div style="text-align: right;">
      <div style="font-size: 13px; font-weight: 500; color: #606070;">Professional</div>
